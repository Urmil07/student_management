            ...
            <div class="auth-box">
                <div>
                    <div class="logo">
                        ...
                        <h5 class="font-medium m-b-20">Sign Up to Teacher Dasshboard</h5>
                    </div>
                    <!-- Form -->
                    <div class="row">
                        <div class="col-12">
                            <form class="needs-validation" method="POST" action="" novalidate>
                                ...
                                <div class="form-group m-b-0 m-t-10 ">
                                    <div class="col-sm-12 text-center ">
                                        Already have an account? <a href="<?=base_url('authentication_teacher')?>" class="text-info m-l-5 "><b>Sign In</b></a>
                                    </div>
                                </div>
                            </form>
                        </div>
