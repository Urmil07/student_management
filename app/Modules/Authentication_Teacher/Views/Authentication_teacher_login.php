    ...
    <div class="auth-box">
        <div id="loginform">
            <div class="logo">
                ...
                <h5 class="font-medium m-b-20">Sign In to Teacher Dashboard</h5>
            </div>
            <!-- Form -->
            <div class="row">
                <div class="col-12">
                    <form class="form-horizontal m-t-20" id="loginform" method="POST" action="<?= base_url('authentication_teacher/authenticate') ?>">
                        ...
                        <div class="form-group m-b-0 m-t-10">
                            <div class="col-sm-12 text-center">
                                Don't have an account? <a href="<?= base_url('authentication_teacher/register') ?>" class="text-info m-l-5"><b>Sign Up</b></a>
                            </div>
                        </div>
                        <div class="form-group m-b-0 m-t-10">
                            <div class="col-sm-12 text-center">
                                If You'r Student <a href="<?= base_url() ?>" class="text-info m-l-5"><b>Sign In</b></a>
                            </div>
                        </div>
                    </form>
                </div>
